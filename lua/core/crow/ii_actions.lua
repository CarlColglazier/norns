...
actions.disting.load_preset = function(msb,lsb) crow.send("ii.disting.load_preset("..msb..","..lsb..")") end
actions.disting.save_preset = function(msb,lsb) crow.send("ii.disting.save_preset("..msb..","..lsb..")") end
...
actions.disting.wav_record = function() crow.send("ii.disting.wav_record()") end
actions.disting.wav_playback = function() crow.send("ii.disting.wav_playback()") end
...
actions.disting.midi = function(status,b1,b2) crow.send("ii.disting.midi("..status..","..b1..","..b2..")") end
actions.disting.voice_pitch = function(voice,pitch) crow.send("ii.disting.voice_pitch("..voice..","..pitch..")") end
actions.disting.note_on = function(voice,velocity) crow.send("ii.disting.note_on("..voice..","..velocity..")") end
actions.disting.note_off = function(voice) crow.send("ii.disting.note_off("..voice..")") end
...
actions.wdel.lowpass = function(cutoff) crow.send("ii.wdel.lowpass("..cutoff..")") end
...
actions.wtape.pre_level = function(gain) crow.send("ii.wtape.pre_level("..gain..")") end
...
actions.wtape.head_order = function(previous) crow.send("ii.wtape.head_order("..previous..")") end
